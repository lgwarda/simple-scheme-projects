...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex-084-edit-editor) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
; Constans:
...
(define (edit ed ke)
  (cond[(key=? ke "left") (cursor-l ed)]
       ...
       [(key=? ke "\b") (delete-l ed)] [(key=? ke "\r") ed]
       [(key=? ke "\t") ed]

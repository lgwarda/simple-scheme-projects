...
(module+ test
  ...
  (define suite
    (test-suite
     ...
     (test-equal? "returns 1" (hand-dist-points '(sa s10 s7 s6 s2 hq hj h9 ck c4 dk d9 d3)) 1)
     (test-equal? "returns 3" (hand-dist-points '(h3 d7 sk s3 c10 dq d8 s9 s4 d10 c7 d4 s2)) 3)

     (test-equal? "returns 14" (bridge-val '(sa s10 s7 s6 s2 hq hj h9 ck c4 dk d9 d3)) 14)
     (test-equal? "returns 8" (bridge-val '(h3 d7 sk s3 c10 dq d8 s9 s4 d10 c7 d4 s2)) 8)))

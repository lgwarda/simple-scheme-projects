...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex-180-editor-text) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
; Constans
...
; main : String -> Editor
; launches the editor with (main "I love pierogi")
(define (main s)
...
(define (editor-text s)
  (text (impl s) FONT-SIZE FONT-COLOR))

; Lo1s -> String
; concatenates the given list of 1-letter strings into one string
(check-expect (impl '()) "")
(check-expect (impl good) "good")

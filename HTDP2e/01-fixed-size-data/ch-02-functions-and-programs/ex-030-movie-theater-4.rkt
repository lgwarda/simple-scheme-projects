...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex-030-movie-theater-4) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
; constans:
(define AVG-ATTENDENCE 120) 
(define BASE-TICKET-PRICE 5.0)
(define ATTENDEE-SWING 15)
(define PRICE-VARIANCE 0.1)
(define PRICE-ATTENDENCE (/ ATTENDEE-SWING PRICE-VARIANCE))
